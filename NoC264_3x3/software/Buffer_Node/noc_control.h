...
//------------------------------------------------------------------------------
#ifdef CPU_0_NOC_CTRL_BASE
//compiled for cpu 0
#define NOC_CTRL_BASE CPU_0_NOC_CTRL_BASE
...
#define NOC_STS_BASE  CPU_0_NOC_STS_BASE
#else
//compiled for cpu 1
#define NOC_CTRL_BASE CPU_1_NOC_CTRL_BASE
...
#define NOC_STS_BASE  CPU_1_NOC_STS_BASE
#endif
...
#define CPU_0_ADDR    0
#define CPU_1_ADDR    7
#define IQIT_0_ADDR   1
#define DB_0_ADDR     2
#define INTRA_0_ADDR  3
#define LINTER_0_ADDR 5
#define CINTER_0_ADDR 4
#define VGA_0_ADDR    8
#define LINTER_1_ADDR 6
...
//------------------------------------------------------------------------------
//-- WHY ARE THESE MACRO NAMES SOOOO LONG?!?!?! --------------------------------
//------------------------------------------------------------------------------
//seriously, why?
#define RD_PIO IORD_ALTERA_AVALON_PIO_DATA
#define WR_PIO IOWR_ALTERA_AVALON_PIO_DATA

//------------------------------------------------------------------------------
//-- FUNCTIONS AND DATA TYPES --------------------------------------------------
//------------------------------------------------------------------------------
//buffer storage constants
#define MAX_FLITS   33
...
inline void send_flit(uint32_t dest, uint32_t word0, uint32_t word1, uint32_t set_tail);
